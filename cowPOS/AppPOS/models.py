...
class Prodact_Name(models.Model):
    ...
    P_name = models.CharField('商品名', max_length=255, null=True, blank=True) # 品名
...
class Accounting_Data(models.Model):
    ...
    name = models.ForeignKey(Prodact_Name, on_delete=models.SET_NULL, null=True, related_name='related_prodact_name')
    price = models.IntegerField('売れた個数', null=True, blank=True) # 売れた個数
    saled = models.IntegerField('売れた値段', null=True, blank=True) # 売れた定価
